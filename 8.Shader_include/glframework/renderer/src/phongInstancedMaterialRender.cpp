...
void Renderer::phongInstancedMaterialRender(const std::shared_ptr<Shader> &shaderPtr,
                                            ...
                                            const std::shared_ptr<AmbientLight> &ambientLight)
{
        ...
        Renderer::processSpecularMask<PhongInstancedMaterial>(shaderPtr, phongMaterial);
