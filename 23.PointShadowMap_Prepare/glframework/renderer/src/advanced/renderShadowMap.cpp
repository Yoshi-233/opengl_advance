...
void Renderer::renderDirectionalShadowMap(const std::vector<std::shared_ptr<Mesh>> &meshes,
...
void Renderer::renderDirectionalCSMShadowMap(std::shared_ptr<Camera> &camera,
...
void Renderer::renderPointShadowMap(std::shared_ptr<Camera> &camera,
                                    const std::vector<std::shared_ptr<Mesh>> &meshes,
