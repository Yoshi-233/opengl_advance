...
void prepareAll()
{
        ...
        planeMat->setDiffuse(std::make_shared<Texture>("assets/textures/normal/brickwall.jpg", 0,
                                                     GL_SRGB_ALPHA));
        // 法线贴图是计算用的, 不需要转化到SRGB, 烘焙法线的软件也不会转化SRGB
        ...
        // planeMesh->rotateX(-90.0f); // 这里倒下但是法线没有变化
